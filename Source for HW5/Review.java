...
public class Review {
	 ...
	 * 
	 * The parameters <code>language</code> and <code>rating</code> are handled according to
	 * {@link Review#setLanguage(String)} and {@link Review#setRating(int)}. 
	 * 
	 ...
	 * 
	 * If the specified language is <code>null</code>, then the language is set to an empty {@link String}. 
	 * 
	 ...
	 * 
	 * If the specified rating is lower than {@link Review#MIN_RATING},
	 * then the rating is set to {@link Review#MIN_RATING}.
	 * If the specified rating is greater than {@link Review#MAX_RATING},
	 * then the rating is set to {@link Review#MAX_RATING}.
	 * 
