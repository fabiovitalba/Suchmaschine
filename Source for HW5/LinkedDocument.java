 ...
 * 
 * A linked document is a specialised {@link Document} that has links to other {@link LinkedDocument}s.
 * 
 * @author
 *
 */
public class LinkedDocument extends Document {
	...
	/**
	 * Returns a new {@link LinkedDocument} instance, that is created from the specified file.
	 * 
	 ...
	 * </ol>
	 * 
	 * If the file cannot be read correctly or if it has less than 2 lines, <code>null</code> will be returned.
	 * 
	 * @param fileName the file to be transformed to a {@link LinkedDocument}
	 * @return a new {@link LinkedDocument} instance, that is created from the specified file.
	 */
	...
	/**
	 * Searches the {@link WordCountArray} of this instance for links
	 * (beginning with {@link LinkedDocument#LINK_PREFIX}) and sets
	 * their count to <code>0</code>.
	 */
	...
	/**
	 * Returns <code>true</code>, if this instance and the specified {@link Document} equal.
	 * 
	 * @param doc the 2nd document
	 * @return <code>true</code>, if the documents equal, <code>false</code> otherwise
	 */
	@Override
	...
	/**
	 * This private helper method uses the {@link String}-Array of IDs.
	 * It creates a new {@link LinkedDocument} for every ID and adds it
	 * to the {@link LinkedDocumentCollection} of outgoing links,
	 * if it is not a self-link.
	 */
	...
	/**
	 * This method returns a {@link LinkedDocumentCollection} that contains
	 * all {@link LinkedDocument}s that this instance links to.
	 * 
	 * @return a {@link LinkedDocumentCollection} containing all {@link LinkedDocument}
	 * this instance links to
	 */
	 ...
	 * 
	 * A link always begins with {@link LinkedDocument#LINK_PREFIX}.
	 * This method returns an array of all IDs that are linked in the specified text
	 * or <code>null</code>, if the specified text is <code>null</code>.
	 * 
	 * @param text the text to find the outgoing links in.
	 * @return array of all IDs that are linked in the specified text
	 * 		or <code>null</code>, if the specified text is <code>null</code>
	 */
	...
	/**
	 * Adds the specified {@link LinkedDocument} to the {@link LinkedDocumentCollection} 
	 * that represents the {@link LinkedDocument}s that link to this instance. 
	 * 
	 * If the specified {@link LinkedDocument} is equal to this instance, it is not added,
	 * since self-links are not allowed.
	 * 
	...
	/**
	 * Returns a {@link LinkedDocumentCollection} of {@link LinkedDocument}s that link to this instance.
	 * 
	 * @return a {@link LinkedDocumentCollection} of {@link LinkedDocument}s that link to this instance
	 */
